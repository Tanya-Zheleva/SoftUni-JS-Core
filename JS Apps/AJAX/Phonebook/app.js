$(() => {
    const baseUrl = 'https://phonebook-1e69f.firebaseio.com/phonebook';
    const list = $('#list');
    ...
    function notify(message, type) {
        ...
        switch (type) {
            case 'error':
                toast.style.backgroundColor = '#991111';
                break;
            case 'success':
                toast.style.backgroundColor = '#119911';
                break;
            case 'info':
                toast.style.backgroundColor = '#111199';
                break;
        }
